         ...
         slots   =   {
            elements   =   {
               Loadout0   =   {
                  bindings   =   {
                     selected   =   {
                        binding   =   "{$UiIngame.loadout_index_weapon_desired == (#self:idx)}"
                     }
                  }
               ...
               loadouts   =   {
                  elements   =   {
                     loadout4   =   {
                        bindings   =   {
                           selected   =   {
                              binding   =   "{$UiGlobals.DeathScreenLoadoutsMode == 'armors' ? $UiIngame.loadout_index_armor_desired == (#self:idx) : $UiIngame.loadout_index_weapon_desired == (#self:idx)}"
                           }
                        }
               ...
               alslots   =   {
                  elements   =   {
                     armorLoadout0   =   {
                        bindings   =   {
                           selected   =   {
                              binding   =   "{$UiIngame.loadout_index_armor_desired == (#self:idx)}"
                           }
                        }
                        __type   =   "hf2p_Loadout_lib::armoryloadoutSlot"
                     }
                     armorLoadout1   =   {
                        bindings   =   {
                           selected   =   {
