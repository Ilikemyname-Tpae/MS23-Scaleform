   ...
   progressBars   =   {
      ...
      elements   =   {
         ...
         tfContainer3   =   {
            bindings   =   {
               textField   =   {
                  binding   =   "{'carousel_armor_stat_weapons'}"
               }
            }
            __type   =   "ui_widget_container"
         }
         tfContainer2   =   {
            bindings   =   {
               textField   =   {
                  binding   =   "{'carousel_armor_stat_protection'}"
               }
            }
            __type   =   "ui_widget_container"
         }
         tfContainer1   =   {
            bindings   =   {
               textField   =   {
                  binding   =   "{'carousel_armor_stat_cqc'}"
               }
            }
            __type   =   "ui_widget_container"
         }
         tfContainer0   =   {
            bindings   =   {
               textField   =   {
                  binding   =   "{'carousel_armor_stat_mobility'}"
               }
            }
            __type   =   "ui_widget_container"
         }
         tfContainer4   =   {
            bindings   =   {
               textField   =   {
                  binding   =   "{'carousel_armor_stat_tech'}"
               }
            }
            __type   =   "ui_widget_container"
         }
         tfContainer5   =   {
            bindings   =   {
               textField   =   {
                  binding   =   "{'carousel_armor_stat_radar'}"
               }
            }
            __type   =   "ui_widget_container"
         }
         bar4   =   {
            elements   =   {
               ...
               barCmp   =   {
                  bindings   =   {
                     colorMult   =   {
                        binding   =   "{GetCmpBarColorArmor('tech')}"
                     }
                     scaleX   =   {
                        binding   =   "{GetMaxArmorStat('tech')}"
                     }
                  }
                  __type   =   "ui_widget_container"
               }
            ...
            elements   =   {
               bar   =   {
                  bindings   =   {
                     ...
                     scaleX   =   {
                        binding   =   "{GetMinArmorStat('weapons')}"
                     }
                  }
                  __type   =   "ui_widget_container"
               }
               barCmp   =   {
                  bindings   =   {
                     colorMult   =   {
                        binding   =   "{GetCmpBarColorArmor('weapons')}"
                     }
                     scaleX   =   {
                        binding   =   "{GetMaxArmorStat('weapons')}"
                     }
                  }
                  __type   =   "ui_widget_container"
               }
            ...
            elements   =   {
               bar   =   {
                  bindings   =   {
                     ...
                     scaleX   =   {
                        binding   =   "{GetMinArmorStat('protection')}"
                     }
                  }
                  __type   =   "ui_widget_container"
               }
               barCmp   =   {
                  bindings   =   {
                     colorMult   =   {
                        binding   =   "{GetCmpBarColorArmor('protection')}"
                     }
                     scaleX   =   {
                        binding   =   "{GetMaxArmorStat('protection')}"
                     }
                  }
                  __type   =   "ui_widget_container"
               }
         ...
         bar1   =   {
            elements   =   {
               ...
               barCmp   =   {
                  bindings   =   {
                     colorMult   =   {
                        binding   =   "{GetCmpBarColorArmor('cqc')}"
                     }
                     scaleX   =   {
                        binding   =   "{GetMaxArmorStat('cqc')}"
                     }
                  }
                  __type   =   "ui_widget_container"
               }
            ...
            elements   =   {
               bar   =   {
                  bindings   =   {
                     ...
                     scaleX   =   {
                        binding   =   "{GetMinArmorStat('mobility')}"
                     }
                  }
                  __type   =   "ui_widget_container"
               }
               barCmp   =   {
                  bindings   =   {
                     colorMult   =   {
                        binding   =   "{GetCmpBarColorArmor('mobility')}"
                     }
                     scaleX   =   {
                        binding   =   "{GetMaxArmorStat('mobility')}"
                     }
                  }
                  __type   =   "ui_widget_container"
               }
         ...
         bar5   =   {
            elements   =   {
               ...
               barCmp   =   {
                  bindings   =   {
                     colorMult   =   {
                        binding   =   "{GetCmpBarColorArmor('radar')}"
                     }
                     scaleX   =   {
                        binding   =   "{GetMaxArmorStat('radar')}"
                     }
                  }
                  __type   =   "ui_widget_container"
               }
      ...
      __type   =   "ui_weaponConf_lib_slide::armorProgressBars"
   }
   ArmorModifiersPanel   =   {
      x   =   1022
      y   =   277
