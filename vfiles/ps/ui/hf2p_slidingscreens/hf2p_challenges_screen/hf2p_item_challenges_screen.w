...
y   =   -277
handlers   =   {
   CloseItemChallengesPopup   =   {
      handlerName   =   "#OnCloseItemChallengesPopup"
   }
}
elements   =   {
   challengesList   =   {
   ...
   challengeTypeTabs   =   {
      ...
      __type   =   "hf2p_WeaponConf_lib::ChallengesTabs"
   }
   challengePopup   =   {
      x   =   7
      bindings   =   {
         DC   =   {
            binding   =   "{challengePopupVM}"
         }
         visible   =   {
            binding   =   "{isVisible}"
         }
      }
      __type   =   "hf2p_ChallengesPopup_lib::ChallengesPopup"
   }
}
stateMap   =   {
   startState   =   "Initial"
